...
Note the 3 different configuration files:
- params.yml   - the most effetive setting to show the required metrics as documented in the CPD knowledge center  (write only, 8 threads for latency based, 2 threads for throughput based)
